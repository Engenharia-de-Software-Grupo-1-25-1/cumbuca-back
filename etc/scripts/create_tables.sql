...
CREATE OR REPLACE VIEW PUBLIC.V_USUARIO
AS
SELECT U.ID,
       U.EMAIL,
       U.SENHA,
...
GROUP BY E.ID, E.NOME, E.CATEGORIA, E.RUA, E.NUMERO, E.BAIRRO, E.CIDADE, E.ESTADO, E.CEP, F.ID;

CREATE OR REPLACE VIEW PUBLIC.V_AVALIACAO
AS
SELECT A.ID,
       A.ID_USUARIO,
